...
class GreyedDialog(QDialog, Ui_GreyedDialog):
    def __init__(self, center_widget, title, parent, hide_close=False, width=None):
        ...
        # if expand_v:
        #     self._get_spacer_top().changeSize(0, 100, QSizePolicy.Preferred, QSizePolicy.Preferred)
        #     self._get_spacer_bottom().changeSize(
        #         0, 100, QSizePolicy.Preferred, QSizePolicy.Preferred
        #     )
        if main_win:
